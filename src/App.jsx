...
function App() {
  return (
    <div className="app-wrapper">
      ...
      {/* ✅ This padding prevents navbar overlap */}
      <main className="pt-20">
        <Routes>
          {/* ✅ Home should show Hero */}
        ...
        <footer
          ...
          style={{
            background:
              "linear-gradient(90deg, #000000 0%, #1a1a2e 50%, #232526 100%)",
          }}
        >
          {/* Social Icons Row */}
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 py-8">
            <a
              href="https://drive.google.com/file/d/1FuFJwtfSJm7PVASgWZE8JFzfKmzJKATQ/view"
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-full border-2 border-white w-11 h-11 sm:w-12 sm:h-12 flex items-center justify-center text-xl hover:bg-white hover:text-black transition-colors duration-200"
            >
              <svg
              ...
              >
                <path d="M21.805 10.023h-9.765v3.955h5.627c-.242 1.236-1.457 3.627-5.627 3.627-3.389 0-6.146-2.805-6.146-6.25s2.757-6.25 6.146-6.25c1.93 0 3.227.822 3.97 1.53l2.713-2.637C16.07 2.422 13.97 1.5 11.5 1.5 5.977 1.5 1.5 5.977 1.5 11.5s4.477 10 10 10c5.73 0 9.5-4.02 9.5-9.75 0-.65-.07-1.15-.195-1.727z" />
              </svg>
            </a>

            <a
              href="https://www.instagram.com/teslavnit/"
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-full border-2 border-white w-11 h-11 sm:w-12 sm:h-12 flex items-center justify-center text-xl hover:bg-white hover:text-black transition-colors duration-200"
            >
            ...
            <a
              href="https://in.linkedin.com/company/tesla-club-of-innovation"
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-full border-2 border-white w-11 h-11 sm:w-12 sm:h-12 flex items-center justify-center text-xl hover:bg-white hover:text-black transition-colors duration-200"
            >
          ...
          <div className="py-4 text-center text-xs sm:text-sm md:text-base border-t border-white/10">
